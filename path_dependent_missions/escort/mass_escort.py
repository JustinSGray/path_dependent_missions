...
def escort_problem(optimizer='SLSQP', num_seg=3, transcription_order=5,
                           ...
                           climb_time=350., starting_mass=19030.468):
...
if __name__ == '__main__':
    ...
    for i, starting_mass in enumerate([22000., 20000.]):

        # 323.64 is the actual min time to climb for 20k
        # 208.926 for 14k
        p = escort_problem(optimizer='SNOPT', num_seg=10, transcription_order=3, starting_mass=starting_mass)
        ...
        for j, phase in enumerate([p.model.climb, p.model.escort]):
            ...
            axarr[2].set_yticks([15000., 20000., 22000.])
