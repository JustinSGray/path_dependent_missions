...
phase.set_objective('power')

phase.add_control('m_flow', opt=True, val=1., lower=0., dynamic=True)
...
p['phase.states:T'] = phase.interpolate(ys=[0., -10.], nodes='disc')
# p['phase.controls:m_flow'] = phase.interpolate(ys=[3., 3.], nodes='disc')
p['phase.controls:m_flow'] = 0.2
